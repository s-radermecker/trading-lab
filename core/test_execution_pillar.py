...
def main() -> None:
    ...
    macro_thesis = build_macro_thesis(
        info_objects=infos,
        asset_scope=["EURUSD"],
        thesis_id="macro_exec_test_001",
    )

    regime_thesis = build_regime_thesis(
        info_objects=infos,
        asset_scope=["EURUSD"],
        thesis_id="regime_exec_test_001",
    )

    sentiment_thesis = build_sentiment_thesis(
        info_objects=infos,
        asset_scope=["EURUSD"],
        thesis_id="sentiment_exec_test_001",
    )
    ...
    print()
    print("=== PROCESS ===")
    print(process_thesis.to_dict())
    print()
    print("=== EXECUTION ===")
    print(execution_thesis.to_dict())
