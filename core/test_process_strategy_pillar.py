...
def main() -> None:
    ...
    macro_thesis = build_macro_thesis(
        info_objects=infos,
        asset_scope=["EURUSD"],
        thesis_id="macro_proc_test_001",
    )

    regime_thesis = build_regime_thesis(
        info_objects=infos,
        asset_scope=["EURUSD"],
        thesis_id="regime_proc_test_001",
    )

    sentiment_thesis = build_sentiment_thesis(
        info_objects=infos,
        asset_scope=["EURUSD"],
        thesis_id="sentiment_proc_test_001",
    )
